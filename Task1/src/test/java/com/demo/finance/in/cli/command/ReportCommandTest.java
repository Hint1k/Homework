...
class ReportCommandTest {
    ...
    void testGenerateFullReport_Success() {
        Report mockReport = new Report(2L, 5000.0, 3000.0);
        ...
        assertEquals("Report: Income=5000.0, Expense=3000.0, Balance=2000.0",
    ...
    void testGenerateReportByDate_Success() {
        ...
        Report mockReport = new Report(2L, 2000.0, 1500.0);
    ...
    void testAnalyzeExpensesByCategory_Success() {
        ...
        when(reportController.analyzeExpensesByCategory(
                eq(2L), eq("2025-03-01"), eq("2025-03-31")
        )).thenReturn(Map.of("Food", 500.0, "Transport", 200.0));
