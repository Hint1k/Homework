...
class TransactionControllerTest {
    ...
    void testGetTransaction() {
        ...
        Transaction mockTransaction = new Transaction(1L, 1L, 100.0, "Groceries",
    ...
    void testGetTransactionsByUserId() {
        ...
        List<Transaction> mockTransactions = Arrays.asList(
                new Transaction(1L, 1L, 100.0, "Groceries", LocalDate.now(),
                        "Weekly shopping", Type.EXPENSE),
                new Transaction(2L, 1L, 200.0, "Salary", LocalDate.now(),
    ...
    void testFilterTransactions() {
        ...
        List<Transaction> mockTransactions = List.of(
                new Transaction(1L, 1L, 100.0, "Groceries",
