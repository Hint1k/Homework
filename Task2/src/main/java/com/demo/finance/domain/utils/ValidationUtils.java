...
public interface ValidationUtils {
     ...
     */
    BigDecimal promptForPositiveBigDecimal(String message, Scanner scanner);

    /**
     * Prompts the user for an optional positive BigDecimal value.
     *
     * @param message The message to display when prompting the user.
     * @param scanner The scanner used for user input.
     * @return A positive BigDecimal entered by the user, or null if no input is provided.
     */
    BigDecimal promptForOptionalPositiveBigDecimal(String message, Scanner scanner);
